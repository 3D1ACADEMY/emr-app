...
- Data-driven typed danger-zone module (`src/features/dangerZone/data/zones.ts`) with 12 approved zones, citation, reviewer, review date, risk tier, anastomoses, warning signs, and immediate actions.
...
### Engineering
- All new clinical content is data-driven and typed via TypeScript (`dangerZone.types.ts`, `zones.ts`); no clinical prose is hard-coded in the view.
